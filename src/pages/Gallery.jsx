...
export function Gallery() {
  const images = [
    ...
    { url: 'https://images.unsplash.com/photo-1761945729356-34eb5f7c9254?auto=format&fit=crop&q=80&w=1000', breed: 'Pygmy Heritage', location: 'Main Barn' },
    ...
    { url: 'https://images.unsplash.com/photo-1741456868875-30574ef99e55?auto=format&fit=crop&q=80&w=1000', breed: 'Sanctuary Life', location: 'Eco-Orchard' },
    { url: 'https://images.unsplash.com/photo-1511117833450-142f2e5db8af?auto=format&fit=crop&q=80&w=1000', breed: 'Miniature Alpine', location: 'Morning Meadows' },
    { url: 'https://images.unsplash.com/photo-1516467508483-a7212febe31a?auto=format&fit=crop&q=80&w=1000', breed: 'Heritage Blend', location: 'Fiber Fields' },
    { url: 'https://images.unsplash.com/photo-1515598692794-06cba770eefc?auto=format&fit=crop&q=80&w=1000', breed: 'Mountain Mix', location: 'High Cliffs' },
    { url: 'https://images.unsplash.com/photo-1484557918186-75c17945ade0?auto=format&fit=crop&q=80&w=1000', breed: 'Meadow Breed', location: 'Hillside' },
    { url: 'https://images.unsplash.com/photo-1532509854226-a2d9d8e66305?auto=format&fit=crop&q=80&w=1000', breed: 'Dwarf Portrait', location: 'Green House' },
  ]
